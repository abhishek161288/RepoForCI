...
class PreferencesView: UIView {
    ...
    static let identifier:String = "PreferencesView"
    var value: Values?
...
extension PreferencesView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
